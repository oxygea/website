export default {
  ...
  invest: {
    ...
    card1: {
      ...
      info: 'Reintegration of waste into the production chain (reverse logistics, recycling, waste based products)',
      info2: 'Enhanced longevity of applications',
      info3:
        'Reduction of material requirements in production, use, or disposal',
      info4: 'Supply chain Traceability',
      info5: 'Digital platforms for shared and circular economy',
    },
    card2: {
      title: 'Carbon Neutrality',
      info: 'Capture, storage, and conversion of CO2 into new chemicals.',
      info2: 'Carbon Market (tracking and footprint)',
      info3: 'Energy transition',
    },
    card3: {
      title: 'Smart Factories and Future Mobility',
      info: 'Implementation of Industry 4.0: Industrial IoT, Computer Vision, AI/ML',
      info2: 'Logistics 4.0 for efficiency and improved traceability',
    },
    card4: {
      title: 'Advanced Biochemicals and New Materials',
      info: 'Biological and biochemical routes for chemical and material production.',
      info2: 'Digital technologies to accelerate R&D developments',
    },
  },
  numbers: {
  ...
  startup: {
    ...
    title3: 'programs to',
    title4: 'understand',
    title5: 'which one best',
    title6: 'fits the stage of',
    title7: 'your startup.',
  },
  programs: {
    title: 'Programs',
  ...
  cover: {
    connect1: 'We connect with',
    connect2: 'global reference',
    connect3: 'partners and',
    connect4: 'specialized',
    connect5: 'advisors.',
    innovation:
      'people who sleep and wake up thinking about innovation, just like you.',
  },
  partners: {
    title: 'Partners',
    desc: 'Colaboration is key for better results. We interact with both local and globally renowned institutions. Such networks share expertise and provide what startups need the most.',
  },
  mentors: {
    title: 'Mentors',
  ...
  news: {
    title: 'In the news',
    desc: 'Be sure to catch the updates on Oxygea and see what the media is talking about our topics of interest. Stay within the trends, opportunities, and challenges of the market.',
    highlight: 'Highlight',
    other: 'Other news',
    read: 'READ MORE',
  },
